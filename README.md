...
I can write huge descriptions for each of these projects; they certainly aren't of utter complexity, but rather meant to show some of the basic (and not so basic) principles to begginers.
